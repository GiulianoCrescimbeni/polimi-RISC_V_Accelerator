    ...
    /*
     * Back-to-back mac_8 accumulator forwarding.
     * The second mac_8 consumes x12 produced by the first.  mac_8 is single-cycle
...
_start:
    ...
    .word    0x02B5560B          # mac_8 x12, x10, x11  -> x12 = 0 + 2*3 = 6
    .word    0x035A560B          # mac_8 x12, x20, x21  -> x12 = 6 + 4*5 = 26 (0x1A)
    nop
    nop
    nop
    nop
